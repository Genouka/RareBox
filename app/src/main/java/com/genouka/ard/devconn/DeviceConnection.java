        ...
        new Thread(new Runnable() {
                ...
                public void run() {
                    ...
                    try {
                        ...
                        socket.connect(new LocalSocketAddress("/adb-hub", LocalSocketAddress.Namespace.ABSTRACT));
                    } catch (IOException e) {
                    ...
                    try {
                        ...
                        connection = AdbConnection.create(new LocalSocketCell(socket), crypto);
                        connection.connect();
	...
	public void startConnectAS() {
		new Thread(new Runnable() {
			...
			public void run() {
				...
				try {
					/* Establish the application layer connection */
					connection = AdbConnection.create(new SocketCell(socket), crypto);
					connection.connect();
