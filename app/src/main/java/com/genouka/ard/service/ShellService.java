...
public class ShellService extends Service implements DeviceConnectionListener {
	...
	private Map<String, DeviceConnection> currentConnectionMap =
	...
	public class ShellServiceBinder extends Binder {
		...
		public DeviceConnection findConnection(String hostwithport) {
            return currentConnectionMap.get(hostwithport);
		}
